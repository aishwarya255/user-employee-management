...
<body>  
<%@page import="pkg.cakedbc,pkg.user"%>  
...
<div class="top"><h1><b>USERMANAGEMENT<b></h1></div>  
<div class="top1"><h3><b>USER_FORM</b></h3></div>
       ...
       <div class="title"><h3><b>FULLNAME</b></h3></div>   
         <div class="title"><form:input maxlen="6" path="fullname"  /> </div>   
         <div class="title"><h3><b>ADDRESS</b></h3></div>  
         <div class="title"> <form:input  path="address"  />  </div> 
         <div class="title"><h3><b>PHONE_NUMBER</b></h3></div>    
          <div class="title"> <form:input path="phone" /> </div> 
         <div class="title"><h3><b>USERNAME</b></h3></div>    
           <div class="title"><form:input  path="uname" /> </div> 
            <div class="title"><h3><b>PASSWORD</b></h3></div>    
           <div class="title"><form:input type="password" path="password" /> </div> 
         ...
         <div class="w3-container">
              ...
              <input type="submit" class="smt" value="Save" />   
              </div> 
