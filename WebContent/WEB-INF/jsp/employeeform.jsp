...
<body>  
<%@page import="pkg.cakedbc,pkg.employee"%>  
...
<div class="top1"><h3><b>EMPLOYEE_FORM</b></h3></div>
       ...
       <div class="title"><h3><b>NAME</b></h3></div>   
         <div class="title"><form:input  path="name"  /> </div>   
         <div class="title"><h3><b>CONTACT_NO</b></h3></div>  
         <div class="title"> <form:input  path="contactno"  />  </div> 
         <div class="title"><h3><b>EMAIL</b></h3></div>    
          <div class="title"> <form:input path="email" /> </div> 
